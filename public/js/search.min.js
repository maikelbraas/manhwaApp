...
search.addEventListener('input', searchManhwa); search.addEventListener('focus', () => {
    searchContainer.style.width = '100%'; searchContainer.style.backgroundColor = '#212529'; if (isUserUsingMobile()) searchContainer.style.right = '0';
