...
app.use(session({ secret: uuidv4(v4options).toString(), resave: false, saveUninitialized: false, cookie: { sameSite: 'lax', maxAge: 30 * 24 * 60 * 100, httpOnly: true, hostOnly: true, secure: true } }));
